...
const uint8_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    FN1,NUBS,Z,   X,   C,   V,   B,   N,   M,   COMM,DOT, SLSH,     RO,  RSFT,          UP,           P1,  P2,  P3,  PEQL,    EXEC,PSTE,
...
const action_t PROGMEM fn_actions[] = {
  [0] = ACTION_LAYER_TAP_KEY(1, KC_SPACE),    // FN0: spaceFN
  [1] = ACTION_MODS_TAP_KEY(MOD_LSFT, KC_TAB),// FN1: LSHIFT-TAB dual key
};
